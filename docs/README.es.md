...
Lee inventarios de dispositivos desde archivos Excel, se conecta por SSH/Telnet, ejecuta comandos de inspección, analiza salidas y genera libros de resultados.
